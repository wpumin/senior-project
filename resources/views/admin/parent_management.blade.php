            ...
            <table class="table display data-table text-nowrap">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="{{ url('admin/management/parent/edit') }}"><span class="flaticon-edit"></span></a><a href="#" data-toggle="modal" data-target="#deleteUser"><span class="flaticon-bin"></span></a>
                        </td>
                    </tr>
                    <tr>
                        <td>2</td>
