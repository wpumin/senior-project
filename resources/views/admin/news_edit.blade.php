    ...
    <div class="card-body pt-5">
        ...
        <form id="addUserForm" class="mb-5 mb-lg-0 new-added-form">
            ...
            <div class="row">
                ...
                <input required type="text" placeholder="หัวข้อข่าวสาร" class="form-control" value="{{ $title }}">
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-12 form-group">
                <input required type="text" placeholder="วันที่เผยแพร่" class="form-control air-datepicker calendar" value="{{ $release_date }}">
                    <i class="far fa-calendar-alt"></i>
                </div>
                <div class="col-xl-3 col-lg-6 col-12 form-group">
                    <input required type="text" placeholder="เวลาเผยแพร่" class="form-control" id="timepicker" value="{{ $release_time }}">
                    <i class="far fa-clock"></i>
                </div>
                <div class="col-xl-12 col-12 form-group">
                    <textarea required class="textarea form-control" name="address" placeholder="รายละเอียดข่าว" rows="15">{{ $content }}</textarea>
                </div>
