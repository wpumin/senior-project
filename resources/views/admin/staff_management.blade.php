            ...
            <table class="table display data-table text-nowrap" id="myTable">
                ...
                <tbody>
                    ...
                    {{-- <tr>
                        ...
                        <td>
                            {{ url('admin/management/staff/edit') }} //ต้องปิด
...
<script>
    ...
    function myFunction() {
          ...
          for (i = 0; i < tr.length; i++) {
            ...
            td_name = tr[i].getElementsByTagName("td")[3]; //choose table that search. (Name)
            td_phone = tr[i].getElementsByTagName("td")[5]; //choose table that search. (Phone)
