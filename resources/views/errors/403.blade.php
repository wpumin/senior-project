...
@section('title','You do not have permission')
        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex flex-column justify-content-center align-items-center login-form animated fadeInUp">
                    ...
                    <p class="text-center my-3"> คุณไม่มีสิทธิ์ใช้หน้าดังกล่าว <span class="spinner-border"> </span></p>
                    <h1 class="text-center my-3 d-none"> 403 page</h1>
                    <div class="my-3">
